...
def glicko2_scores(df, TAU=0.5,  START_RATING=1500., START_RD=350., START_VOL=0.06, CONVERGENCE_TOLERANCE=1e-5, datetime_stop=None,
    ...
    for index, row in df.iterrows():
        ...
        is_date_passed = (datetime_stop is not None and row[datetime_col] > datetime_stop)
